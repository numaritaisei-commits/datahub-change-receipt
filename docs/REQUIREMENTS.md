...
| Free Project/test URL | Public repo provides a clean-checkout, accountless fixture path; public CI is supporting evidence | Complete; final lightweight verify run #8 passed |
